...
\begin{itemize}
  ...
  \item you can type set math in LaTeX,
...
\emph{Sketch} is a tool for defining a 3D scene using a simple descriptive language.
...
\fullciteinbox{baca2021mrs}{Some meaningful description comes here:}
...
\begin{figure}[!h]
  ...
  \caption{Example of using Tikz for image overlays. (a) shows a final product, (b) shows a grid, that is useful for nailing down the coordinates.}
